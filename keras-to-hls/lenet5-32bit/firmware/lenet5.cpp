		  ...
		  unsigned short &const_size_out)
{
    ...
    #pragma HLS STREAM variable=conv2d_layer1_out depth=1
...
//    #pragma HLS STREAM variable=layer2_out depth=1
    ...
    #pragma HLS STREAM variable=pool2d_layer2_in depth=1
    ...
    #pragma HLS STREAM variable=pool2d_layer2_out depth=1
...
//    nnet::flatten<layer1_t, OUT_HEIGHT_2, OUT_WIDTH_2, N_FILT_2>(pool2d_layer2_out, layer2_out);
    ...
    #pragma HLS STREAM variable=conv2d_layer3_out depth=1
    ...
    #pragma HLS STREAM variable=pool2d_layer4_in depth=1
    ...
    #pragma HLS STREAM variable=pool2d_layer4_out depth=1
    ...
    #pragma HLS STREAM variable=logits5 depth=1
    ...
    #pragma HLS STREAM variable=logits6 depth=1
    ...
    #pragma HLS STREAM variable=logits7 depth=1
